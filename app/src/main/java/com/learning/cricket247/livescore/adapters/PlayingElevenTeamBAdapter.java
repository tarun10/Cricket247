...
public class PlayingElevenTeamBAdapter extends RecyclerView.Adapter<PlayingElevenTeamBAdapter.ViewHolder> {
    private ArrayList<Players> playersArrayList;
    private Context context;

    public PlayingElevenTeamBAdapter(ArrayList<Players> playersArrayList, Context context) {
